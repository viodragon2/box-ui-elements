export default {
  ...
  "be.contentSidebar.activityFeed.taskForm.taskAnyInfoTooltip": "デフォルトでは、タスクを完了するにはすべての担当者がタスクを実行する必要があります。このオプションを選択すると、割り当てられているうちの1人がタスクを完了すればこのタスクは完了となります。",
